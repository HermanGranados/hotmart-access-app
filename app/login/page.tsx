  ...
  return (
    ...
    >
      <div className="w-full max-w-[390px]">
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={loading}
              className="w-full rounded-2xl py-[19px] text-[17px] font-bold text-white transition disabled:opacity-60"
              style={{
                background: "#2D74DA",
        ...
        {/* Créditos */}
        <div className="mt-6 flex flex-col items-center gap-[6px]">
