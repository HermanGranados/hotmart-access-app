...
export default function LoginPage() {
  ...
  <div className="absolute h-[150px] w-[150px] rounded-[42px] bg-gradient-to-br from-cyan-200/70 via-blue-200/60 to-violet-200/60 blur-3xl opacity-70" />

  <div className="relative h-[132px] w-[132px] overflow-hidden rounded-[34px] shadow-[0_20px_50px_rgba(15,23,42,0.18)] ring-1 ring-white/60 bg-white/40 backdrop-blur-xl">
    <img
