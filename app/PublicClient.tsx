            ...
            <div>
              ...
              <div className="space-y-3">
                <button onClick={() => setVista("mac")}
                  ...
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden flex-shrink-0" style={{ background: "linear-gradient(135deg,#e0f2fe,#bae6fd)" }}>
                ...
                <button onClick={() => setVista("locu")}
                  className="w-full bg-white rounded-[20px] border border-slate-100 p-4 flex items-center gap-4 text-left shadow-sm hover:shadow-md transition-all active:scale-[0.99]">
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center overflow-hidden flex-shrink-0" style={{ background: "linear-gradient(135deg,#f0fdf4,#dcfce7)" }}>
